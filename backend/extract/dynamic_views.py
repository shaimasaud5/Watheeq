...
from .serializers import DynamicExtractSerializer
...
class DynamicExtractAPIView(GenericAPIView):
   serializer_class = DynamicExtractSerializer
   ...
   def post(self, request, *args, **kwargs):
         ...
         print("LLM RESULT IN POST:", llm_result)
         print("LLM RESULT TYPE IN POST:", type(llm_result))
         if isinstance(llm_result, dict):
            if structure_source == "template_text":
